...
const Favourite = () => {
  ...
  return(
    <div className="container mx-auto">
      ...
      <h1 className='text-4xl font-bold p-5'>EXPLORE FAVOURITE COLLECTIONS</h1>
      ...
      <div className="container grid md:md:grid-cols-3 gap-4">
        {
          collections && collections?.map((collection)=>(
            ...
            <LinkTo key={collection?.collectionId} className="group relative border-2 border-slate-400 p-2 rounded-md" href={`collections/${collection.name}`}>
